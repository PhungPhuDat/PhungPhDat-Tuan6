package com.example.ActiveMQ_Recevier.restcontroller;

import com.example.ActiveMQ_Recevier.data.Person;
import com.example.ActiveMQ_Recevier.helpper.XMLConvert;
...
public class ReviceController {
    ...
    public String getMessToMq() throws NamingException {
        try {
            ...
            System.out.println("ngochai was listened on queue...");
